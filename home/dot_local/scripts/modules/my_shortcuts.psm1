...
function aliases {
    ...
    ce $HOME\Documents\PowerShell\profile.ps1 $HOME\OneDrive\Documentos\PowerShell\Microsoft.PowerShell_profile.ps1 $HOME\OneDrive\Documentos\profile.ps1  $modules\my_git.psm1 $modules\my_rclone.psm1 $modules\my_shortcuts.psm1 $modules\my_tools.psm1 
}
function vimrc {
    ce $dotfiles\_vimrc
}
